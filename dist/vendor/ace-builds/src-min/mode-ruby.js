      ...
      , d = function() {
        ...
        this.$rules = {
            start: [{
                ...
                onMatch: function(e, t, n) {
                    return this.next = "",
                    e == "}" && n.length > 1 && n[1] != "start" && (n.shift(),
                    this.next = n.shift()),
                    this.token
                }
            }, {
            ...
            qStateWithInterpolation: [{
                ...
                regex: /[(\[<{]/,
                onMatch: function(e, t, n) {
                    return n.length && e === n[0] ? (n.unshift(e, t),
                    this.token) : "string"
                }
            }, {
                token: "constant.language.escape",
                ...
                regex: /[)\]>}^|%]/,
                onMatch: function(e, t, n) {
                    return n.length && e === v[n[0]] ? (n.shift(),
                    this.next = n.shift(),
            ...
            sStateWithoutInterpolation: [{
                ...
                onMatch: function(e, t, n) {
                    return n.length && e === n[0] ? (n.unshift(e, t),
                    this.token) : "constant.other.symbol.ruby"
                }
            }, {
                token: "constant.other.symbol.ruby",
                regex: /[)\]>}^|%]/,
            ...
            rState: [{
                ...
                onMatch: function(e, t, n) {
                    return n.length && e === n[0] ? (n.unshift(e, t),
                    this.token) : "constant.language.escape"
                }
            }, {
                token: "paren.start",
                regex: /#{/,
                ...
                regex: /[)\]>}^|%][imxouesn]*/,
                onMatch: function(e, t, n) {
                    return n.length && e[0] === v[n[0]] ? (n.shift(),
                    this.next = n.shift(),
                    this.token) : (this.next = "",
...
define("ace/mode/folding/ruby", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range", "ace/token_iterator"], function(e, t, n) {
    ...
    function() {
        ...
        this.getFoldWidgetRange = function(e, t, n) {
            ...
            if (i)
                return i[1] || i[3] ? this.rubyBlock(e, n, i.index + 2) : this.openingBracketBlock(e, "{", n, i.index);
            var i = this.foldingStopMarker.exec(r);
            if (i)
                return i[3] === "end" && e.getTokenAt(n, i.index + 1).type === "keyword" ? this.rubyBlock(e, n, i.index + 1) : i[1] === "=end" && e.getTokenAt(n, i.index + 1).type === "comment.multiline" ? this.rubyBlock(e, n, i.index + 1) : this.closingBracketBlock(e, "}", n, i.index + i[0].length)
        }
        ,
        this.rubyBlock = function(e, t, n, r) {
            ...
            if (!u)
                return null;
            if (r)
                return v.push(i.getCurrentTokenRange()),
                v;
